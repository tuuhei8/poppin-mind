...
const content={
 ...
 sv:{tag:'Kontakt',title:'Kontakta oss',subtitle:'Oavsett om du har en fråga eller är redo att boka en session vill vi gärna höra från dig.',successTitle:'Tack för att du hörde av dig',successText:'Ditt meddelande har markerats som skickat i detta demoformulär. I live-versionen kan formuläret kopplas till e-post eller bokningssystem.',name:'Ditt namn',namePh:'t.ex. Alex Jansen',email:'E-postadress',emailPh:'alex@example.com',phone:'Telefon (valfritt)',phonePh:'+358 40 123 4567',service:'Intresserad av',select:'Välj en tjänst (valfritt)',options:['Mental coaching','Lösningsfokuserad coaching','Lösningsfokuserad korttidsterapi','Djurassisterad coaching','Jag är inte säker ännu'],message:'Ditt meddelande',messagePh:'Berätta lite om vad du söker eller ställ de frågor du har...',send:'Skicka meddelande',privacyTitle:'Din integritet är viktig',privacyText:'Allt du delar med oss — i detta formulär och i våra sessioner — behandlas med högsta konfidentialitet. Du kan tala fritt och känna dig trygg.',locationTitle:'📍 Plats',locationText:'Sessioner erbjuds online och på plats. Kontakta oss för mer information om platsen.',responseTitle:'⏰ Svarstid',responseText:'Vi strävar efter att svara inom 24–48 timmar.'},
}
